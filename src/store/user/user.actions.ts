...
import { AdditionnalDetails, UserData } from '../../utils/firebase/firebase.utils';
import {
	Action,
	ActionWithPayload,
	createAction,
...
export type SignUpSuccess = ActionWithPayload<
	...
	{ user: User; additionnalDetails: AdditionnalDetails }
>;
...
export const signUpSuccess = withMatcher(
	(user: User, additionnalDetails: AdditionnalDetails): SignUpSuccess =>
